# Contributing to paymenthub-ee-bulk-processor

Thank you for your interest in contributing to the paymenthub-ee-bulk-processor! We welcome contributions from the community to help improve financial inclusion solutions globally.
...
- Have a look at our [Wiki](https://github.com/openMF/paymenthub-ee-bulk-processor/wiki).
...
- Fork the [project](https://github.com/openMF/paymenthub-ee-bulk-processor) on GitHub
- Clone the project locally into your system.

```bash
git clone https://github.com/your-username/paymenthub-ee-bulk-processor.git
```
...
```bash
git remote add upstream https://github.com/openMF/paymenthub-ee-bulk-processor.git
```

2. Use `git remote -v` to check the status. The output must be something like this:

```bash
  > origin    https://github.com/your-username/paymenthub-ee-bulk-processor.git (fetch)
  > origin    https://github.com/your-username/paymenthub-ee-bulk-processor.git (push)
  > upstream  https://github.com/openMF/paymenthub-ee-bulk-processor.git (fetch)
  > upstream  https://github.com/openMF/paymenthub-ee-bulk-processor.git (push)
```
